# SeismoFNO Benchmark: FNO Core vs. Physics Losses vs. LSTM & MLP Baselines

Evaluation across unseen earthquake events (Held-Out-Earthquake Split) disaggregated by elastic regime ($\mu \le 1.0$) vs. post-yield regime ($\mu > 1.0$):
