...
- **[Academic Research Statement (PDF)](docs/RESEARCH_BRIEF.pdf)** ([Markdown](docs/RESEARCH_BRIEF.md)) — Research statement formulated for faculty reviewing Scientific ML, neural operator architectures, and structural dynamics.
